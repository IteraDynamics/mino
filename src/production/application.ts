...
export async function createProductionApplication(
  ...
  try {
    ...
    const adminAgentLifecycle = new PostgresAdminAgentLifecycleService(
      sql,
      adminAudit,
      generateId,
      clock,
    );
    const adminPolicyManagement = new PostgresAdminPolicyManagementService(
      sql,
      adminAudit,
      generateId,
      clock,
    ...
    app = await createApp({
      ...
      ...(adminAccess
        ? {
            ...
            adminAgentLifecycle: {
              ...adminAccess,
              agentLifecycle: adminAgentLifecycle,
            },
